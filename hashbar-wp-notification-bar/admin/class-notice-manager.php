...
class Hashbar_Notice_Manager{

    // Remote URL
    const REST_ROUTE_URL = 'https://feed.hasthemes.com/notices';
    // const REST_ROUTE_URL = HASHBAR_WPNB_URI;

    // Transient Key
    const TRANSIENT_KEYS = [
        'notice'  => 'hashbar_notice_info',
    ];

    // API Endpoint
    const API_ENDPOINT = [
        'notice'      => 'hashbar-wp-notification-bar.json',
    ];
    ...
    public static function get_api_endpoint(){
        if( is_plugin_active('hashbar-pro/init.php') && function_exists('hashbar_pro_notice_endpoint') ){
            return hashbar_pro_notice_endpoint();
        }
