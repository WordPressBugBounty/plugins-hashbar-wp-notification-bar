...
define( 'HASHBAR_WPNB_VERSION', '1.9.7');
...
add_action( 'wp_body_open', 'hashbar_wpnb_load_notification_to_footer' );
add_action( 'wp_footer', 'hashbar_wpnb_load_notification_to_footer', 999 );
